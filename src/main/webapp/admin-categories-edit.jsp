            ...
            <div class="card-body">
              ...
              <form  name="productForm" method="post" action='' onsubmit="return validateFormOrder()">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                      <input type="text"  value=""  name='oid' readonly="" class="form-control" >
                  </div>
                </div>
                  <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                  <div class="col-sm-10">
                    <input type="text" name='name' value="" class="form-control" id="inputText">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label"> Description</label>
                  <div class="col-sm-10">
                      <input type="text" name='des' value="" class="form-control" id="inputEmail">
                  </div>
                </div>
